...
while True:
    try:
        ...
        print("Invalid utme score. please enter a number.")
    finally:
        print("Checking utme score")
...
if "ENGLISH" not in o_level_result or "MATHEMATICS" not in o_level_result: #or "ENG" not in o_level_result or "MATH" not in o_level_result:
    ...
    while True:
        try:
            ...
            print("Invalid post utme score. please enter a valid number.")
        finally:
            print("Checking post utme score")
